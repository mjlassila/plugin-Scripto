<?php
$head = array('title' => html_escape(__('Scripto | Transcribe Page')));
head($head);
?>
...
jQuery(document).ready(function() {
    ...
    jQuery('#scripto-transcription-page-edit').click(function() {
        jQuery('#scripto-transcription-page-edit').prop('disabled', true).text('<?php echo __("Editing transcription..."); ?>');
        jQuery.post(
            ...
            function(data) {
                jQuery('#scripto-transcription-page-edit').prop('disabled', false).text('<?php echo __("Edit transcription."); ?>');
    ...
    jQuery('#scripto-talk-page-edit').click(function() {
        jQuery('#scripto-talk-page-edit').prop('disabled', true).text('<?php echo __("Editing discussion..."); ?>');
        jQuery.post(
            <?php echo js_escape(uri('scripto/index/page-action')); ?>, 
            {
                page_action: 'edit', 
            ...
            function(data) {
                jQuery('#scripto-talk-page-edit').prop('disabled', false).text('<?php echo __("Edit discussion"); ?>');
    ...
    jQuery('#scripto-page-watch').text('<?php echo __("Unwatch page"); ?>').css('float', 'none');
    <?php else: ?>
    jQuery('#scripto-page-watch').text('<?php echo __("Watch page"); ?>').css('float', 'none');
    <?php endif; ?>
    ...
    jQuery('#scripto-page-watch').click(function() {
        if ('Watch page' == jQuery(this).text()) {
            ...
            jQuery.post(
                ...
                function(data) {
                    jQuery('#scripto-page-watch').prop('disabled', false).text('<?php echo __("Unwatch page"); ?>');
                }
            );
        } else {
            ...
            jQuery.post(
                ...
                function(data) {
                    jQuery('#scripto-page-watch').prop('disabled', false).text('<?php echo __("Watch page"); ?>');
                }
            );
        }
    });
    ...
    jQuery('#scripto-transcription-page-protect').text('<?php echo __("Unprotect page"); ?>').css('float', 'none');
    <?php else: ?>
    jQuery('#scripto-transcription-page-protect').text('<?php echo __("Protect page"); ?>').css('float', 'none');
    <?php endif; ?>
    ...
    jQuery('#scripto-transcription-page-protect').click(function() {
        if ('Protect page' == jQuery(this).text()) {
            ...
            jQuery.post(
                ...
                function(data) {
                    jQuery('#scripto-transcription-page-protect').prop('disabled', false).text('<?php echo __("Unprotect page"); ?>');
                }
            );
        } else {
            ...
            jQuery.post(
                ...
                function(data) {
                    jQuery('#scripto-transcription-page-protect').prop('disabled', false).text('<?php echo __("Protect page"); ?>');
                }
            );
        }
    });
    ...
    jQuery('#scripto-talk-page-protect').text('<?php echo __("Unprotect page"); ?>').css('float', 'none');
    <?php else: ?>
    jQuery('#scripto-talk-page-protect').text('<?php echo __("Protect page"); ?>').css('float', 'none');
    <?php endif; ?>
    ...
    jQuery('#scripto-talk-page-protect').click(function() {
        if ('Protect page' == jQuery(this).text()) {
            ...
            jQuery.post(
                ...
                function(data) {
                    jQuery('#scripto-talk-page-protect').prop('disabled', false).text('<?php echo __("Unprotect page"); ?>');
                }
            );
        } else {
            jQuery(this).prop('disabled', true).text('<?php echo __("Unprotecting page..."); ?>');
            jQuery.post(
                ...
                function(data) {
                    jQuery('#scripto-talk-page-protect').prop('disabled', false).text('<?php echo __("Protect page"); ?>');
                }
            );
        }
    });
    ...
    jQuery('#scripto-transcription-page-import').click(function() {
        ...
        jQuery.post(
            ...
            function(data) {
                jQuery('#scripto-transcription-page-import').prop('disabled', false).text('<?php echo __("Import page"); ?>');
            }
        );
    });
    ...
    jQuery('#scripto-transcription-document-import').click(function() {
        ...
        jQuery.post(
            ...
            function(data) {
                jQuery('#scripto-transcription-document-import').prop('disabled', false).text('<?php echo __("Import document"); ?>');
            }
        );
    });
...
<div id="scripto-transcription">
    ...
    [<a href="<?php echo html_escape(uri(array('item-id' => $this->doc->getId(), 'file-id' => $this->doc->getPageId(), 'namespace-index' => 0), 'scripto_history')); ?>"><?php echo __('history'); ?></a>]</h2>
    <div>
...
<div id="scripto-talk">
    ...
    [<a href="<?php echo html_escape(uri(array('item-id' => $this->doc->getId(), 'file-id' => $this->doc->getPageId(), 'namespace-index' => 1), 'scripto_history')); ?>"><?php echo __('history'); ?></a>]</h2>
    <div>
